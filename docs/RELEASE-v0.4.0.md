...
![Main window](https://github.com/muanton/virt-manager-modern/raw/v0.4.0/docs/screenshots/main.png)

## Download

| Asset | Notes |
|---|---|
| `VirtManagerModern-0.4.0.zip` | Notarized app bundle (~13 MB). Unzip, drag to Applications. |
| `VirtManagerModern-0.4.0.zip.sha256` | Checksum — verify before opening. |

```sh
shasum -a 256 -c VirtManagerModern-0.4.0.zip.sha256
```
...
This release corresponds to git tag **`v0.4.0`** in this repository. The
project is licensed under the
[GNU General Public License v2.0](../LICENSE). Corresponding source for the
distributed binary is available at:

https://github.com/muanton/virt-manager-modern/tree/v0.4.0
...
- Upload ISO from Storage Pools manager
- Download volumes (incl. ISOs) from host to Mac via libvirt streams
